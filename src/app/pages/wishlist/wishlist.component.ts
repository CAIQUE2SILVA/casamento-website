...
@Component({
  ...
  template: `
    <div class="container">
      ...
      <div class="loading" *ngIf="loading">Carregando lista de desejos...</div>
        ...
        <div class="wishlist-item" *ngFor="let presente of presentes">
          ...
          <div class="wishlist-info">
            ...
            <div class="actions" *ngIf="presente.disponivel">
              <button class="reserve-btn" (click)="openReserveModal(presente)">
                Reservar
              </button>
              <a
                [href]="presente.link"
      ...
      <div class="modal" *ngIf="selectedPresente" (click)="closeModal()">
        <div class="modal-content" (click)="$event.stopPropagation()">
          ...
          <div class="modal-item-info">
            <img
              [src]="selectedPresente.imagem"
              [alt]="selectedPresente.nome"
            />
            <div>
              <h3>{{ selectedPresente.nome }}</h3>
              <p class="price">
                R$ {{ selectedPresente.preco | number : '1.2-2' }}
              </p>
            </div>
          </div>
          ...
          <form (ngSubmit)="reservePresente()">
            ...
            <button type="submit" [disabled]="!reservationName">
              Confirmar Reserva
            </button>
          </form>
        </div>
